...
export default class Panels extends Component {
  ...
  render() {
    const { defaultPanel, blackoutPanel, successPanel, errorPanel } = this.state;
      ...
      <div>
        ...
        <D>
          ...
          >
            ...
            <Panel context="blackout" className={m.mtr}>
              Blackout
            </Panel>
            <Panel context="success" className={m.mtr}>
              Success
            </Panel>
            <Panel context="error" className={m.mtr}>
              Error
            </Panel>
          </Specimen>
          <Note className={m.mtr}>
            <T elm="p">
              Be sure to provide enough meaning in the content of the panel itself, as opposed to
              relying on the additional context provided by the <C>context</C> prop and the colours
              this provides you. This is to ensure that users of assistive technologies are able to
              fully understand the content and are not reliant on the colour of the panel.
            </T>
          </Note>
        </D>
        <D>
          ...
          <T elm="p" className={m.mtr}>
            Use to make the panel dismissible by a user. Available in the same contexts as the
            standard panel.
          </T>
          <Note className={m.mtr}>
            <T elm="p">
              We also provide a <C>Notification</C> component. For now, this is an alias of the{' '}
              <C>DismissablePanel</C>. Use it where providing the additional context makes sense,
              i.e., when you are notifying the user of something.
            </T>
          </Note>
          <Specimen
            classNames={{
          ...
          >
            ...
            {panelsClosed && <Placeholder onClick={this.resetPanels}>Reset state</Placeholder>}
          </Specimen>
        </D>
      </div>
    );
