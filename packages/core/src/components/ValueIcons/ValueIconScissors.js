...
const ValueIconScissors = (props: Props) => {
  ...
  return (
    <span className={cx(defaultcss.root, className)} {...(rest: any)}>
      <svg viewBox="0 0 63.06 42">
        ...
        <path
          d={
            'M33.71,24.25l2.5,5.88,3.64,8.58a2.86,2.86,0,0,0,3.73,1.51l2.25-1a2.86,2.86,0,0,0,' +
        ...
        <path
          d={
            'M28.51,21.18a3.39,3.39,0,0,1,2.6-3.31l.39-.07,2-4.13,6-12.14a2.93,2.93,0,0,1,' +
