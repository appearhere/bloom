...
export default {
  ...
  'automatic-payments': automaticPayments,
  'calendar-insight': calendarInsight,
  'chart-arrow': chartArrow,
  'play-c': playC,
  'chevron-right': chevronRight,
  'tick-c': tickC,
  'tick-starred': tickStarred,
  'travel-idea': travelIdea,
  'vip-entrance': vipEntrance,
  'card-list': cardList,
  account: account,
