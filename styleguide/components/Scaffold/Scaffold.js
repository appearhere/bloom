...
export const H = ({ level, className, children }) =>
  createElement(
    `h${level}`,
    {
      className: cx(
...
export const T = ({ elm, className, children }) =>
  createElement(
    elm,
    {
...
export const List = ({ className, children, type, ...rest }) =>
  createElement(
    `${listTypes[type]}l`,
    {
...
export const Placeholder = ({ className, children, onClick, ...rest }) => (
  <BtnContainer {...rest} className={cx(css.placeholder, className)} onClick={onClick}>
    {children}
  </BtnContainer>
);
...
export const Bq = ({ className, children, citation, ...rest }) => (
  <div>
    <blockquote {...rest} className={cx(css.blockquote, className)}>
      {children}
    </blockquote>
    <cite>{citation}</cite>
  </div>
