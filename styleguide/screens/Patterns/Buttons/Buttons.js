...
const Buttons = () => (
  <div>
    ...
    <D>
      ...
      >
        <Btn className={ cx(css.btn, m.widthFull) }>Default</Btn>
      </Specimen>
    </D>
    <D>
      <H level={ 2 }>BtnGroup</H>
      <T elm="p" className={ m.mtr }>
      ...
      >
        <BtnGroup className={ css.btn }><Btn>Default</Btn><Btn>Default</Btn></BtnGroup>
        <BtnGroup className={ css.btn } context="primary"><Btn>Primary</Btn><Btn>Primary</Btn></BtnGroup>
        <BtnGroup className={ css.btn } context="action"><Btn>Action</Btn><Btn>Action</Btn></BtnGroup>
        <BtnGroup className={ css.btn } context="danger"><Btn>Danger</Btn><Btn>Danger</Btn></BtnGroup>
        <BtnGroup className={ css.btn } context="whiteout"><Btn>Whiteout</Btn><Btn>Whiteout</Btn></BtnGroup>
      </Specimen>
    </D>
    <D>
      <H level={ 2 }>BtnContainer</H>
      <T elm="p" className={ m.mtr }>
